...
class Casa {
    ...
    atualizaPlacar() {
        var jogadorDaRodada = jogo.jogadorDaRodada;
        
        if(jogadorDaRodada.cor == "preta") {
            const pontosJogadorDaRodada = document.getElementById(`pontosJogador${1}`);
            const pecaCapturadasJogadorDaRodada = document.getElementById(`pecasCapturadasJogador${1}`);
            pontosJogadorDaRodada.textContent = parseInt(pontosJogadorDaRodada.textContent) + 1;
            pecaCapturadasJogadorDaRodada.textContent = parseInt(pecaCapturadasJogadorDaRodada.textContent) + 1;
        } else {
            const pontosJogadorDaRodada = document.getElementById(`pontosJogador${2}`);
            const pecaCapturadasJogadorDaRodada = document.getElementById(`pecasCapturadasJogador${2}`);
            pontosJogadorDaRodada.textContent = parseInt(pontosJogadorDaRodada.textContent) + 1;
            pecaCapturadasJogadorDaRodada.textContent = parseInt(pecaCapturadasJogadorDaRodada.textContent) + 1;
        }
        ...
        if (!movimentoValido) {
            ...
            if (movimentoValido) {
                ...
                if (casa.vazia()) {
                    ...
                    if (casa.peca.jogadorDonoDaPeca === casa.tabuleiro.jogo.jogadorDaRodada) {
                        movimentoValido = false;
                    }
                    else {
...
let jogadorPretas = new Jogador("jogador1", "Guilherme", "preta")
let jogadorVermelhas = new Jogador("jogador2", "Walid", "vermelha")
